...
<body>
    <div class="head">
        ...
        <div class="page">
            <ul type="None">
                <a href="index.php"><li class="l1">Home</li></a>
                <a href="medical.php"><li class="l1">Medical</li></a>
                <a href="index.php"><li class="l1">Contact</li></a>
                <a href="index.php"><li class="l1">Login</li></a>
                <a href="index.php" class="about">About Us</a>
            </ul>
        </div>     
    </div>
    ...
    <div class="service1" id="c1">
        ...
        <div class="map1">
            <iframe class="map2" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d949.4295284833113!2d75.29603362917062!3d17.851844475771593!2
            m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc4151bd002e9dd%3A0x6c6ce9d973d4e09d!2sShree%20Medical!5e0!3m2!1sen!2sin
            !4v1679743326320!5m2!1sen!2sin" width="450" height="250" style="border:2px solid black;" allowfullscreen="" loading="lazy" 
        ...
        <div class="info1">
            ...
            <div class="sub-menu-wrap" id="subMenu1">
                <div class="sub-menu">
                    <marquee style="height: fit-content; background-color: aquamarine;"><h3 style="margin: 0%; color: blue;">SHREE MEDICAL STORE (Chemist and Drugist)</h3></marquee>
                    <p>Owner - Shrikant Bamane</p> 
                    <p>Contact - 7777777777 <a href="tel:+918765432190"><i class="fa fa-phone" style="border: 2px solid red;" aria-hidden="true"></i></a></p>
                    <address>Tulasi</address>
                    <p>Then, use JavaScript to slide down the content by setting a calculated max-height, depending on the panel's height on different screen sizes:
            ...
            <button class="i2" onclick="toggleMenu2()" title="See all available medicines in SHREE MEDICAL"><h3>Medicine</h3></button>
      
            <div class="sub-menu-wrap" id="subMenu2">
                <div class="sub-menu" style="background-color: aqua;">
                    <h3>Owner - Shrikant Bamane </h3>
                    <h3>Contact - 7876875656</h3>
                    <h3>Email - shrikant@gmail.com</h3>
                    <h3>Follow us</h3> 
                    <h3>Then, use JavaScript to slide down the content by setting a calculated max-height, depending on the panel's height on different screen sizes:
                        Then, use JavaScript to slide down the content by setting a calculated max-height, depending on the panel's height on different screen sizes:
                        Then, use JavaScript to slide down the content by setting a calculated max-height, depending on the panel's height on different screen sizes:
                        Then, use JavaScript to slide down the content by setting a calculated max-height, depending on the panel's height on different screen sizes:
                    </h3>  
            ...
            <button class="i3" onclick="toggleMenu3()" title="Special treatments medicines"><h3>Special Medicine</h3></button>
      
            <div class="sub-menu-wrap" id="subMenu3">
                <div class="sub-menu" style="background-color: cornsilk;">
                    <h3>Owner - Shrikant Bamane </h3>
                    <h3>All the medicines related to humans deseases are available. Some special medicines are available.</h3>
                    <h3>Contact - 7876875656</h3>
                    <h3>Email - shrikant@gmail.com</h3>
                    <h3>Follow us</h3>  
                </div>
   ...
   <div class="service1" id="c2">
                ...
                <div class="sub-menu">
                    ...
                    <div class="in">
                        <div class="in1">
                            ...
                            <button type="button" style="margin-left: 40px;"><a href="suvarna@gmail.com"><i class="fa fa-envelope-o" aria-hidden="true"> contact via Email</i></a></button>
                        </div>
                        <div class="in2">
    ...
    <div class="service1" id="c3">
        ...
        <div class="info1">
            ...
            <div class="sub-menu-wrap" id="subMenu31">
                <div class="sub-menu">
                    <marquee><h3>SHREE MEDICAL STORE (Chemist and Drugist)</h3></marquee>
                    <h3>Owner - Shrikant Bamane </h3>
                    <h3>Contact - 7777777777 <a href="tel:+918765432190"><i class="fa fa-phone" style="border: 2px solid red;" aria-hidden="true"></i></a></h3>
                    <h3>Email - shrikant@gmail.com</h3>
                    <h3>Then, use JavaScript to slide down the content by setting a calculated max-height, depending on the panel's height on different screen sizes:
                    Then, use JavaScript to slide down the content by setting a calculated max-height, depending on the panel's height on different screen sizes:
                    Then, use JavaScript to slide down the content by setting a calculated max-height, depending on the panel's height on different screen sizes:
            ...
            <button class="i2" onclick="toggleMenu32()" title="See all available medicines in SHREE MEDICAL"><h3>Medicine</h3></button>
            ...
            <button class="i3" onclick="toggleMenu33()" title="Special treatments medicines"><h3>Special Medicine</h3></button>
    ...
    <div class="service1" id="c4">
        ...
        <div class="info1">
            ...
            <button class="i2" onclick="toggleMenu42()" title="See all available medicines in SHREE MEDICAL"><h3>Medicine</h3></button>
            ...
            <button class="i3" onclick="toggleMenu43()" title="Special treatments medicines"><h3>Special Medicine</h3></button>
    ...
    <div class="service1" id="c5">
        ...
        <div class="info1">
            ...
            <button class="i2" onclick="toggleMenu52()" title="See all available medicines in SHREE MEDICAL"><h3>Medicine</h3></button>
            ...
            <button class="i3" onclick="toggleMenu53()" title="Special treatments medicines"><h3>Special Medicine</h3></button>
    ...
    <div class="service1" id="c6">
        ...
        <div class="info1">
            ...
            <button class="i2" onclick="toggleMenu62()" title="See all available medicines in SHREE MEDICAL"><h3>Medicine</h3></button>
            ...
            <button class="i3" onclick="toggleMenu63()" title="Special treatments medicines"><h3>Special Medicine</h3></button>
